                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                                  <tr>
                                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0px;word-break:break-word;">
                                      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1;text-align:center;color:#000000;"> <span style="font-size: 30px; color: #4390B1;"><b></b></span> </div>
                                    </td>Near By Doctor
                                  </tr>
                                </table>
                              </div>
                                  ...
                                  <tr>
                                    <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0px;padding-bottom:0px;word-break:break-word;">
                                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                        <tbody>
                                          <tr>
                                            <td style="width:149px;"> <img alt="CMRCET" height="auto" src="https://www.cmrcet.ac.in/Design/img/cmrlogo.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;" width="149" /> </td>
                                          </tr>
                                        </tbody>
                                      </table>
                                    </td>
            ...
            <div style="background:#DCF0F9;background-color:#DCF0F9;Margin:0px auto;border-radius:30px;max-width:600px;">
              <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="background:#DCF0F9;background-color:#DCF0F9;width:100%;border-radius:30px;">
                ...
                <tr>
                  ...
                  </span><br /><br /><br /> <span style="font-weight: bold; font-size: 15px; color: grey">Hey ${userData.username}!<br/><br/>
                                    Lost your password? Don't worry, it happens to the best of us :)
        Use the code below and start enjoying Near By Doctor again by generating a new password.
                                    <br>
                                    <br>
                                    <br>
                                    <p
              ...
              <![endif]-->
                          <div class="mj-column-per-66 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:middle;width:100%;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:middle;" width="100%">
                              <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0px;word-break:break-word;">
                                  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1;text-align:center;color:#000000;"> <span style="font-size: 30px; color: #4390B1;"><b>Near By Doctor</b></span> </div>
                                </td>
                              </tr>
                            </table>
                          </div>
                      ...
                      <tr>
                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                          <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:13px;line-height:1;text-align:center;color:#000000;"> <span style="font-weight: bold; font-size: 21px; color: #45474e">
                                ...
                                We are very excited to have you with us! Use the code below to verify your email, and start using Near By Doctor!
                                <br>
                                <br>
                                <br>
                                <p
              ...
              <![endif]-->
                          <div class="mj-column-per-100 outlook-group-fix" style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:100%;">
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                              <tr>
                                <td align="center" style="font-size:0px;padding:10px;word-break:break-word;">
                                  <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;line-height:1;text-align:center;color:white;">Made with ❤️ by CMRCET</div>
                                </td>
                              </tr>
                              <tr>
                                <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
